<template>
  <div class="min-h-screen bg-bg-primary">
    <div v-if="assignment" class="section-container">
      ...
      <!-- Links (for website) -->
      <div v-if="assignment.liveUrl || assignment.githubUrl || assignment.driveUrl" class="glass-card mb-8">
        ...
        <div class="flex flex-wrap gap-4">
          ...
          <a v-if="assignment.driveUrl" :href="assignment.driveUrl" target="_blank" class="btn-outline-glow inline-flex items-center gap-2">
            <UIIcon name="folder-open" size="sm" class="flex-shrink-0" />
            Google Drive
          </a>
        </div>
      </div>
...
useHead({
  title: () => assignment.value ? `${assignment.value.title} | Elang Permadi Lau` : 'Assignment Not Found',
  meta: [
